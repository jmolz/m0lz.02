...
```json
// Request
{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"config":{"defaultModel":"claude-fable-5"}}}

// Response
{"jsonrpc":"2.0","id":1,"result":{"capabilities":{"workflow":true,"evaluation":true,"agentTeams":false,"models":["claude-fable-5","claude-sonnet-4-6"],"defaultEvalModel":"claude-fable-5"},"version":"0.1.0"}}
```
...
```json
{"jsonrpc":"2.0","id":2,"method":"session/create","params":{"workingDirectory":"/home/user/project","model":"claude-fable-5"}}
