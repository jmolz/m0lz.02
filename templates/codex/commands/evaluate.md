...
### Step 3b: Run Contract Evaluator Pass(es)

For each contract evaluation pass (1 for Tier 1, 1 for Tier 2, 3 for Tier 3 agent team), spawn a **fresh evaluator session** with the configured primary evaluation model and the following prompt.
