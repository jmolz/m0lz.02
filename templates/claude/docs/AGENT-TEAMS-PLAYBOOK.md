...
1. Project architect — set up the directory structure, base configuration
   ...
   (logging, error handling, env config). Follow conventions from CLAUDE.md / AGENTS.md.
...
3. Documentation writer — create README.md with setup instructions,
   guidance files with project conventions, and scoped rule files for
...
4. Rules updater — update CLAUDE.md / AGENTS.md and scoped rule files to match
