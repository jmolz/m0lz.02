...
For each Claude evaluation pass (1 for Tier 1, 1 for Tier 2, 3 for Tier 3 agent team), spawn a **fresh Claude Fable 5 xhigh adaptive sub-agent** (`model: "claude-fable-5"`) with the following prompt.
