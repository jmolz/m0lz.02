...
This project uses **dual-model adversarial evaluation** through PICE evaluation providers. GPT-5.5 with xhigh reasoning acts as a peer-level adversary to Opus 4.8, challenging design decisions and assumptions from a different model family's perspective.
