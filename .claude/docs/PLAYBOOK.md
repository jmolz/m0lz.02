...
**Fable usage policy:** Use Claude Fable 5 at `xhigh` for evaluation/adversarial Claude passes and as the Claude Code fallback model. Keep routine Claude Code sessions on Opus 4.8 xhigh until Fable plan/credit treatment is intentionally re-evaluated.
