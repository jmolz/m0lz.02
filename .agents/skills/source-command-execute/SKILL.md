...
Use this skill when the user asks to run the migrated source command `execute`. Original argument hint: `<path-to-plan.md>`.
...
Read the entire plan at: `{user-provided arguments}`
...
3. **Implement** the change following project patterns from AGENTS.md
...
- Follow project conventions from AGENTS.md at all times
